...
class testCase(unittest.TestCase):
    ...
    @unittest.skipIf("".join(list(filter(lambda x: x=="2.in", os.listdir("testCases")))), "Could not find a second test case")             
    def testCase2(self): self._test_func(2)

    @unittest.skipIf("".join(list(filter(lambda x: x=="3.in", os.listdir("testCases")))), "Could not find a third test case")             
    def testCase2(self): self._test_func(2)
